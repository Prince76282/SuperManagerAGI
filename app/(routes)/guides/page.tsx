    ...
    <div className="min-h-screen bg-[linear-gradient(180deg,rgba(98,95,208,0.08)_0%,#FFFFFF_26%,#FFFFFF_100%)]">
      <section className="mx-auto max-w-6xl px-4 py-18 sm:px-6 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <span className="inline-flex rounded-full bg-[#625FD0]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-[#625FD0]">
              Guides & Playbooks
            </span>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/get-in-touch"
                className="inline-flex items-center gap-2 rounded-full bg-[#625FD0] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#625FD0]/90"
              >
              ...
              <Link
                href="/resource"
                className="inline-flex items-center gap-2 rounded-full border border-[#625FD0]/20 bg-white px-6 py-3 text-sm font-semibold text-[#625FD0] transition hover:bg-[#625FD0]/5"
              >
                Browse resource hub
              </Link>
            </div>
          ...
          <div className="rounded-[32px] border border-[#625FD0]/20 bg-white p-7 shadow-xl shadow-[#625FD0]/10">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl text-gray-950">What these guides help you do</h2>
            </div>
          ...
          {guideEntries.map(({ slug, page }) => (
            ...
            >
              ...
              <div className="mt-6 rounded-[22px] bg-[#625FD0]/6 p-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#625FD0]">
                  Focus
                </p>
              ...
              <span className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[#625FD0]">
                Open guide
