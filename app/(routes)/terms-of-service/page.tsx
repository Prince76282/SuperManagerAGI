          ...
          <article className="prose prose-lg max-w-none">
            <section>
              ...
              <p className="text-gray-700 mb-6">
                By accessing and using SuperManager AGI, you accept and agree to
                be bound by and abide by the terms and conditions outlined in
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ...
                materials (information or software) on SuperManager AGI for
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6">
                In no event shall SuperManager AGI or its suppliers be liable
                ...
                of the use or inability to use the materials on SuperManager
                AGI.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6">
                The materials appearing on SuperManager AGI could include
                technical, typographical, or photographic errors. SuperManager
                AGI does not warrant that any of the materials on the platform
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6">
                SuperManager AGI may revise these Terms of Service for the
                platform at any time without notice. By using this platform, you
            ...
            <section>
              ...
              <p className="text-gray-700 mb-6">
                These Terms of Service and any separate agreements we provide to
                clarify our Services are governed by and construed in accordance
