      ...
      <main className="flex-1 px-6 md:px-10 lg:px-16 py-12 max-w-[1200px] mx-auto w-full">
        <div className="mb-12">
          ...
          <p className="text-gray-500 mt-3 text-base leading-relaxed">
            Complete technical reference for deploying, configuring, and
            operating the SuperManagerAGI platform across your organization.
          </p>
        </div>
        ...
        <section id="overview" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            SuperManagerAGI is an autonomous AI-powered project management
            intelligence layer designed to help managers oversee complex teams,
            tasks, and workflows with minimal manual intervention. It operates
            as a persistent, always-on system that sits above your existing
            tooling stack continuously monitoring, synthesizing, and acting on
            the operational data that your organization generates every day.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            The system continuously analyzes team productivity, project
            timelines, cross-functional dependencies, and operational risk
            signals to automatically optimize project execution and support
            management decision-making. Rather than presenting raw data and
            expecting managers to draw conclusions, SuperManagerAGI interprets
            that data and surfaces specific, actionable intelligence telling
            managers not just what is happening, but what it means and what they
            should do about it.
          </p>
          <p className="text-gray-600 leading-relaxed mb-4">
            Unlike traditional project management tools such as Jira, Trello,
            Linear, or Asana which are fundamentally passive data stores that
            require humans to update, interpret, and act on them SuperManagerAGI
            acts as an active operational participant. It does not wait to be
            queried. It monitors continuously, detects changes automatically,
            and initiates appropriate responses without requiring a human to
            notice a problem and decide to investigate it.
          </p>
          <p className="text-gray-600 leading-relaxed">
            SuperManagerAGI is built for organizations managing complex,
            multi-team projects where coordination overhead is high, information
            is scattered across multiple tools, and the cost of delayed risk
            detection is significant. It is designed to integrate into existing
            workflows without requiring teams to change how they work, and to
            deliver measurable operational improvements from day one of
            deployment.
          </p>
        ...
        <section id="workflow" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            SuperManagerAGI follows a continuous, self-reinforcing AI-driven
            workflow cycle that automatically adapts to project progress, team
            capacity changes, and evolving organizational priorities. The cycle
            runs perpetually once initialized each phase feeding into the next
            and the whole system continuously recalibrating based on new
            information.
          </p>
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.step}
                className="flex gap-5 bg-white border border-gray-200 rounded-xl p-6"
              >
                <span className="text-2xl font-bold text-gray-200 shrink-0 w-10">
                  {item.step}
                </span>
                <div>
        ...
        <section id="architecture" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            The SuperManagerAGI platform is built on a modular, cloud-native
            architecture designed for enterprise-scale reliability, security,
            and extensibility. Each architectural layer is independently
            scalable and communicates through well-defined interfaces, allowing
            the system to handle organizational deployments ranging from single
            teams to global enterprises with hundreds of concurrent projects and
            thousands of active users.
          </p>
          <p className="text-gray-600 leading-relaxed mb-8">
            The architecture follows an event-driven design pattern in which
            operational data from connected tools flows continuously through a
            processing pipeline, triggering the appropriate AI analysis,
            recommendation generation, and notification workflows in near
            real-time. This ensures that insights and alerts are generated and
            delivered as quickly as the underlying data changes, rather than
            being constrained by periodic batch processing cycles.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              >
                <h4 className=" text-gray-900 mb-3">{card.title}</h4>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {card.desc}
                </p>
              </div>
        ...
        <section id="integrations" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            SuperManagerAGI is built to integrate deeply with the tools your
            organization already uses not to replace them, but to connect them
            into a unified operational intelligence layer that is more than the
            sum of its parts. Each integration is purpose-built to capture the
            specific operational signals most relevant to project health
            monitoring and management intelligence, going well beyond the
            surface-level notifications that generic integration platforms
            provide.
          </p>
          <p className="text-gray-600 leading-relaxed mb-8">
            All integrations are configured through the SuperManagerAGI admin
            console and require appropriate OAuth or API key authentication with
            each connected service. Most integrations are operational within
            minutes of initial configuration and begin generating actionable
          ...
          <div className="space-y-6">
            {[
              ...
              >
                <h4 className=" text-gray-900 mb-1">{group.category}</h4>
        ...
        <section id="security" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            SuperManagerAGI is built on an enterprise-grade security
            architecture designed to meet the requirements of organizations with
            the most demanding data security, privacy, and compliance standards.
            Security is not an add-on feature it is a foundational architectural
            principle that informs every aspect of how the platform handles,
            stores, processes, and protects organizational data.
          </p>
          <p className="text-gray-600 leading-relaxed mb-8">
            The platform maintains SOC 2 Type II certification, undergoes
            regular third-party penetration testing, and provides comprehensive
            audit logging for every data access and processing event giving
            security teams full visibility into how organizational data flows
            through the platform at all times.
          </p>
        ...
        <section id="deployment" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            SuperManagerAGI is available in three deployment configurations to
            accommodate organizations with different security requirements,
            infrastructure preferences, and compliance constraints. All
            configurations provide the full feature set the choice of deployment
            model affects where data is processed and stored, not what
            ...
            {[
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <h4 className=" text-gray-900">{item.plan}</h4>
        ...
        <section id="api" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-8">
            All API requests require authentication using an API key issued
            through the SuperManagerAGI admin console. API keys can be scoped to
            specific capabilities and rate-limited to specific request volumes.
            The API is available over HTTPS only and enforces TLS 1.2 minimum
            for all connections.
          </p>
        ...
        <section id="future" className="mb-20 scroll-mt-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            The SuperManagerAGI product roadmap reflects our long-term vision of
            creating a fully autonomous management intelligence platform one
            that handles the complete operational complexity of modern
            organizational management with the kind of contextual intelligence
            and adaptive judgment that has previously required experienced human
            management teams. The roadmap is organized into near-term,
            medium-term, and long-term horizons, each building on the
            capabilities established in the previous horizon.
          </p>
          <p className="text-gray-600 leading-relaxed mb-8">
            Roadmap priorities are informed by customer feedback, usage
            analytics, and our ongoing research into the frontier of AI
            management capabilities. Timeline estimates reflect current
            development priorities and are subject to change as we learn more
            from customer deployments and as underlying AI capabilities evolve.
          </p>
            ...
            {[
              ...
              <div key={horizon.horizon}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className=" text-gray-900">{horizon.horizon}</h3>
