  ...
  return (
    <main className="max-w-5xl mt-4 mx-auto px-6 py-14">
      ...
      <section className="space-y-8 bg-white shadow-sm border rounded-2xl p-8">
        ...
        <p>
          Please review this Privacy Policy carefully. By using our Services,
        ...
        <div>
          ...
          <p>
            ...
            automation, task assignment intelligence, team collaboration, and
            productivity optimization. We only collect and process data
            necessary to provide, maintain, improve, and secure our Services.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Valid communication details including email and phone number
            </li>
          ...
          <p>
            ...
            communication details so we may send verification codes and
        ...
        <div>
          ...
          <p>
            <strong>Business Event Data:</strong> Client emails, change
            requests, defect reports, delivery risks, compliance findings,
            resource issues, SLA breaches, and directives.
          </p>

          <p>
            <strong>Decision Intelligence Data:</strong> Decision
            classification, approval chain, context, alternatives, timestamps,
            and state.
          </p>

          <p>
            <strong>Communication Data:</strong> Emails, chats, meeting
            transcripts, commit messages, and documents.
          </p>

          <p>
            <strong>Team Data:</strong> Roles, workload metrics, skills,
            calendar availability, and assignments.
          </p>
