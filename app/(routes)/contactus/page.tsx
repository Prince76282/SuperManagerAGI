    ...
    <div className="min-h-screen bg-[#f0f4f8] px-4 py-20">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl text-gray-900 mb-2">
            Ways to reach us
          </h1>
          ...
          <div className="md:col-span-2 flex flex-col gap-5">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm flex flex-col">
              ...
              <div className="flex gap-3 mt-auto flex-wrap">
                ...
                <Link
                  href="/learnmore"
                  className="inline-flex items-center gap-2 border-2 border-[#625FD0] text-gray-700 text-xs font-semibold uppercase tracking-widest px-4 py-2.5 rounded-md hover:text-white hover:bg-[#625FD0] transition"
                >
                  Partner Program
        ...
        <div className="bg-white rounded-2xl overflow-hidden shadow-sm">
          <div className="px-6 sm:px-8 pt-8 pb-4 ">
            <h2 className="text-xl sm:text-2xl lg:text-4xl  text-gray-900 mb-1">
              Schedule a Meeting
            </h2>
