  ...
  return (
    <div className="bg-white text-black min-h-screen font-sans">
      ...
      <section className="relative overflow-hidden bg-white border-b border-gray-100">
        ...
        <div className="relative max-w-[1200px] mx-auto px-6 py-28 text-center">
          ...
          <h1 className="text-5xl md:text-5xl font-semibold mt-6 leading-[1.05] tracking-tight text-black">
            Case <span className="text-[#625FD0]">Studies</span>
          </h1>
          ...
          <ul className="mt-8 inline-flex flex-col items-start gap-3 text-left">
            {data.highlights.map((h, i) => (
              ...
              >
                <CheckCircle
                  size={16}
                  className="text-[#625FD0] shrink-0 mt-0.5"
                />
                {h}
              </li>
            ))}
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-20">
        ...
        <h2 className="text-3xl lg:text-5xl  text-black mb-12">
          Where Do You Want to Start?
        </h2>

        <div className="grid md:grid-cols-3 gap-6">
          {data.featuredCards.map(
            ({ kicker, title, href, description, icon: Icon }, i) => (
              <Link
                key={i}
                href={href}
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {data.useCases.map(({ role, scenario, outcome, icon: Icon }, i) => (
            ...
            >
              ...
              <div>
                <p className="text-md  uppercase tracking-widest text-[#625FD0] mb-1">
                  {role}
                </p>
      ...
      <section className="max-w-[1200px] mx-auto px-6 py-24 border-b border-gray-100">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {data.relatedLinks.map(
            ({ title, href, description, icon: Icon }, i) => (
              <Link
                key={i}
                href={href}
