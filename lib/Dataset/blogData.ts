...
export const latest: Latest[] = [
  {
    ...
    title: "How ADA Eliminates the Network Boundary That Makes Enterprise AI Unreliable",
...

  {
    ...
    title: "What 1,000 Feet Deep Actually Means: How SuperManager AGI Retrieves Enterprise Data",

    desc:
      "When we say prompt and get data 1,000 feet deep inside your enterprise, we mean native async connections to your actual databases at 2 to 15ms with per-subtask RAG grounding and HNSW vector retrieval. This piece explains the retrieval architecture in plain language.",
...

  {
    ...
    desc:
      "The organisations that get the most value from SuperManager AGI follow a consistent pattern: start with 2 to 3 high-impact agent deployments in the first 2 weeks, expand to full departmental coverage by day 45 and achieve cross-department coordination by day 90. This piece documents that pattern.",
...
export const articles: Articles[] = [
...

  {
    ...
    title: "Stock-Out Prediction: How Operations AGI Gives You 14 Days of Advance Warning",
...

  {
    ...
    title: "Why Data Sovereignty Is the Enterprise AI Compliance Requirement That Most Platforms Fail",
