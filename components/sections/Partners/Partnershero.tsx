...
const companies = [
  { name: "Adobe", src: "/image/newimage/Adobe.png", width: 130 },
  ...
  { name: "Perplexity", src: "/image/newimage/perplexity.png", width: 130 },
    ...
    <section className="relative bg-white overflow-hidden">
      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-28">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="flex flex-col gap-5">
              <h1 className="text-3xl sm:text-3xl lg:text-4xl xl:text-5xl  text-black leading-[1.1] tracking-tight">
                Our{" "}
              ...
              <p className="text-base sm:text-lg text-slate-700 font-medium  max-w-xl">
                Unlock enterprise value from AI with our global partner ecosystem.
              </p>

              <p className="text-slate-500 text-md sm:text-base max-w-xl">
                Scale faster and achieve measurable outcomes with SuperManagerAGI
                agents and generative AI systems implemented, customized, and
                optimized by certified enterprise specialists.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/learnmore/"
                className="inline-flex justify-center font-semibold  items-center px-6 py-2 rounded-lg border-2 border-[#625FD0] text-[#625FD0] text-sm  transition hover:bg-[#625FD0] hover:text-white w-full sm:w-auto"
              >
                Learn More
              </Link>
            </div>
        ...
        <div className="relative mt-20 text-center">
          <h1 className="mb-10 text-lg sm:text-xl md:text-2xl font-semibold  text-slate-900">
          ...
          <div className="overflow-hidden group">
            <div className="flex w-max items-center gap-10 sm:gap-14 md:gap-20 animate-marquee group-hover:[animation-play-state:paused] will-change-transform">
              {[...companies, ...companies].map((company, index) => (
                <div key={index} className="flex shrink-0 items-center justify-center px-4">
                  <Image
                    src={company.src}
                    alt={company.name}
                    width={company.width}
