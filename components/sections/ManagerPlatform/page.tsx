      ...
      <section className="py-24 px-6 lg:px-20 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-10">
            ...
            leadership layers with intelligent orchestration, reasoning, and execution.
          </p>

          <div className="flex justify-center gap-4 flex-wrap">
            <Link
              href="#capabilities"
              className="bg-[#625FD0] text-white px-8 py-3 rounded-xl font-semibold hover:bg-[#5146d9] transition"
            >
              Explore Platform
            </Link>
            ...
            <Link
              href="/demo"
              className="border border-gray-300 px-8 py-3 rounded-xl font-semibold hover:bg-gray-50 transition"
            >
              Request Demo
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg mb-6">
              ...
              autonomous intelligence system. It simultaneously analyzes strategy,
              resources, risks, and execution paths — then deploys coordinated AGI
              agents to deliver outcomes.
            </p>

            <p className="text-gray-600 text-lg">
              Instead of dashboards and manual decision loops, organizations run on an
              orchestration fabric that plans, allocates, monitors, and optimizes continuously.
            </p>
          </div>
      ...
      <section className="py-24 px-6 lg:px-20 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-16">
            A continuous intelligence loop replacing fragmented management layers
            with autonomous strategic execution.
          </p>

          <div className="grid md:grid-cols-4 gap-10 text-left">

            <div>
              <h4 className="font-semibold text-xl mb-3">Analyze</h4>
            ...
            <div>
              <h4 className="font-semibold text-xl mb-3">Strategize</h4>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-xl mb-3">Orchestrate</h4>
              <p className="text-gray-600 text-sm">
            ...
            <div>
              <h4 className="font-semibold text-xl mb-3">Optimize</h4>
              <p className="text-gray-600 text-sm">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Modular intelligence components working together as a unified enterprise platform.
            </p>
          </div>
