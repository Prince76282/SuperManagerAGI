...
const trendingItems = [
  {
    ...
    title: "The D2C Brand Operator’s Complete Guide to Deploying AI Agents Across Inventory, Logistics, Finance and Marketing",
    icon: Target,
  },
  {
    tag: "Webinar",
    topic: "Competitive Intelligence",
    title: "Why Claude MCP, Manus and Microsoft Copilot Cannot Deliver the Vibe Working Platform: A Technical Breakdown",
    icon: Star,
  },
  {
    tag: "Research",
    topic: "ADA Architecture",
    title: "Agentic Data Architecture: Eliminating the API Layer for Hallucination-Free, Sub-100ms Enterprise AI Agents",
    icon: BarChart2,
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-black/60 text-sm sm:text-base max-w-lg leading-relaxed mb-8">
             Explore research papers, deployment guides, industry reports, webinars and expert insights designed to help founders, operators and enterprise leaders build autonomous AI agent workforces across every department and industry.
            </p>
