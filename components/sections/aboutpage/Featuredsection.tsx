...
export default function HomePage() {
  ...
  return (
    <section ref={sectionRef} className="relative bg-[#F0F6F9] overflow-hidden">
      <div className="relative max-w-[1200px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 pt-16 md:pt-16 lg:pt-16 pb-16">
        ...
        >
          ...
          <div className="flex flex-col gap-8 lg:w-[46%] text-center lg:text-left">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="text-[#181818]/70  text-base md:text-lg leading-relaxed max-w-[560px] mx-auto lg:mx-0">
              ...
              <p className="text-[#181818]/60 text-sm md:text-base leading-relaxed font-light max-w-[520px] mx-auto lg:mx-0">
