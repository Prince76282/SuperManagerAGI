  ...
  return (
    <section className="bg-white text-black py-24">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-10 mb-20">
          ...
          <div className="border-2 border-[#625FD0] rounded-2xl p-10 hover:shadow-xl transition-all">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl ">Enterprise Deployment Support</h3>
            </div>
          ...
          <div className="border-2 border-[#625FD0] rounded-2xl p-10 hover:shadow-xl transition-all">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-xl ">Platform Status</h3>
            </div>
        ...
        {/* Ways to Reach Us */}
        <div className="mb-20">
          <h3 className="text-2xl  mb-10">Ways to Reach Us</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-xl p-6 hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="">Contact Our Expert Team</h4>
              </div>
              <p className="text-black/70 mb-4">
                Explore the platform, discuss your deployment needs or get
                access to start deploying agents immediately.
              </p>
            ...
            <div className="border rounded-xl p-6 hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="">Press and Media</h4>
              </div>
              <p className="text-black/70 mb-4">
            ...
            <div className="border rounded-xl p-6 hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="">Partnership Team</h4>
              </div>
              <p className="text-black/70 mb-4">
            ...
            <div className="border rounded-xl p-6 hover:shadow-md transition">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="">Schedule a Meeting</h4>
              </div>
              <p className="text-black/70 mb-4">
                Pick a time that works for you to speak with the SuperManager
                AGI team about your deployment.
              </p>
              <Link
                href="https://calendly.com/nirmalsupermanageragi/60min?back=1&month=2026-03"
                className="text-[#625FD0] font-medium"
              >
                Book via Calendly →
              </Link>
            </div>
