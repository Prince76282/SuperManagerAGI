...
const recognitions = [
  {
    ...
    body: "Forward-thinking enterprises use SuperManager AGI to design and orchestrate intelligent AI agents that automate complex workflows, streamline operations, and enhance decision-making across teams and business systems.",
  ...
  },
  {
    ...
    body: "SuperManager AGI enables companies to deploy collaborative AI agents capable of research, analysis, operational tasks, and decision support — working alongside human teams to accelerate productivity.",
    ctaLabel: "View Platform",
    ctaHref: "/platform",
    imgSrc: "/Image/SuperManager-AGI.png",
    badge: "AI Workforce",
  },
  {
    ...
    ctaHref: "/",
    imgSrc: "/Image/managers-humans.jpg",
