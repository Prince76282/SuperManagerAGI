  ...
  },
  {
    ...
    visual: {
      ...
      items: [
        ...
        { label: "Standup summary generated from Jira and GitHub ", status: "done", time: "9m ago" },
      ],
    },
  },
  {
    ...
    subheading:
      "Department managers gain a live, grounded view of every active workflow, every pending action and every risk signal across their function  retrieved directly from connected systems in real time, not compiled from manual reports. SuperManager AGI monitors continuously and surfaces what requires human judgment. Everything routine is handled autonomously.",
    highlights: [
      {
        icon: "🎯",
  ...
  },
  {
    ...
    highlights: [
      ...
      },
      {
        ...
        body: "Agents coordinate across departments automatically no escalation meetings required.",
      },
    ],
    visual: {
      ...
      items: [
        ...
        { label: "2 high-velocity SKUs approaching reorder threshold ", status: "done", time: "live" },
        {
          label: "one campaign below threshold brief generated ",
          status: "warn",
          time: "live",
        },
        { label: "generated from 11 connected systems ", status: "done", time: "delivered 9:00am" },
      ],
    },
  },
];
...
export default function AutonomousTabs() {
  ...
  return (
    <section className="relative pb-20 min-h-screen flex flex-col overflow-hidden bg-white">
